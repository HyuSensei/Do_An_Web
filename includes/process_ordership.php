                        ...
                        $check_id_product = $row['id_product'];
                            ...
                            <div class="row">
                                ...
                                <div class="col-5">
                                    <div class="row">
                                         <div class="col-6">
                                            <a href="./includes/process_order_receive.php?id='.$row['id_order'].'"><button style="font-size: 15px;background-color: #820813" type="button" id="show-confirm" class="btn btn-info">Đã Nhận</button></a>
                                         </div>
